...
class DataFormatterTest{
    ...
    fun `given correct ISO 8601 format then should format correctly` (){
        ...
        Assert.assertEquals("02 Feb 2022 | 17:10", DataFormatter.formatDate(currentDate, "Asia/Jakarta"))
        Assert.assertEquals("02 Feb 2022 | 18:10", DataFormatter.formatDate(currentDate, "Asia/Makassar"))
        Assert.assertEquals("02 Feb 2022 | 19:10", DataFormatter.formatDate(currentDate, "Asia/Jayapura"))
    }
    ...
    fun `given wrong ISO 8601 format then should throw error` (){
        ...
        Assert.assertThrows(DateTimeParseException::class.java) {
            DataFormatter.formatDate(wrongFormat, "Asia/Jakarta")
        }
    }
    ...
    fun `given invalid timezone then should throw error` (){
        ...
        Assert.assertThrows(ZoneRulesException::class.java) {
            DataFormatter.formatDate(wrongFormat, "Asia/Bandung")
        }
    }
}